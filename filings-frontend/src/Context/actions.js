...
export const getRequests = async (dispatch) => {
  const result = await fetch("http://3.226.14.5:8000/api/v1/req-data-all");
...
export const getUsers = async (dispatch) => {
  const result = await fetch("http://3.226.14.5:8000/api/users-data-all");
  const content = await result.json();
  if (content) {
...
export const fsgetRequests = async (dispatch) => {
  const jsdata = await axios.get(
    "http://3.226.14.5:8000/api/v1/job-support-data-all"
  );
...
export const enqgetRequests = async (dispatch) => {
  const enqdata = await axios.get(
    "http://3.226.14.5:8000/api/v1/course-enquiry-all"
  );
...
export const cmdgetRequests = async (dispatch) => {
  const cmddata = await axios.get(
    "http://3.226.14.5:8000/api/v1/job-support-comment-data-all"
  );
