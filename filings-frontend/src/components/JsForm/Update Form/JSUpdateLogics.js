...
const UpdateLogics = ({ params, page }) => {
  ...
  const editData = () => {
    axios
      .put(`https://3.226.14.5:8000/api/v1/job-support-data-update`, editedData)
      .then((res) => {
  ...
  const paymentRequests = () => {
    if (paymentsLength === 0) {
      return axios
        .post(
          `https://3.226.14.5:8000/api/v1/job-support-paymnet-data`,
          paymentData
        )
        .then((res) => {
          console.log(res.data);
      ...
      return axios
        .put(
          `https://3.226.14.5:8000/api/v1/job-support-payment-update`,
          paymentUpdateData
        )
        .then((res) => {
          console.log(res.data);
  ...
  //   axios.get("https://3.226.14.5:8000/api/v1/job-support-payment-data-all")
